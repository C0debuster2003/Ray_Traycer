        ...
        for (int b = -11; b < 11; b++) {
            ...
            if ((center - point3(4, 0.2, 0)).length() > 0.9) {
                ...
                if (choose_mat < 0.8) {
                    ...
                    world.add(make_shared<MSphere>(center, center2, 0.0, 1.0, 0.2, sphere_material));
...
int main()
{
    thread t1(run, "D:\\TRayCer\\t1.txt",225,203);
    thread t2(run, "D:\\TRayCer\\t2.txt",203,174);
    thread t3(run, "D:\\TRayCer\\t3.txt",174,145);
    thread t4(run, "D:\\TRayCer\\t4.txt",145,116);
    thread t5(run, "D:\\TRayCer\\t5.txt",116,87);
    thread t6(run, "D:\\TRayCer\\t6.txt",87,58);
    thread t7(run, "D:\\TRayCer\\t7.txt",58,29);
    thread t8(run, "D:\\TRayCer\\t8.txt",29,0);
    t1.join();
    t2.join();
    t3.join();
    t4.join();
