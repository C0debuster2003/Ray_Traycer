...
void run(string path, int s_j, int e_j)
{
    ...
    auto material_center = make_shared<lambertian>(color(0.1, 0.2, 0.4));
    auto material_left = make_shared<metal>(color(0.8, 0.8, 0.8),0.0);  //fuzziness set to 0 for shiny metal
