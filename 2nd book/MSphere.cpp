...
bool MSphere::bounding_box(double time0, double time1, aabb& output_box) const{
    ...
    aabb box0(centre(time0)-point3(radius, radius, radius), centre(time0)+point3(radius, radius, radius));
    aabb box1(centre(time1)-point3(radius, radius, radius), centre(time1)+point3(radius, radius, radius));
